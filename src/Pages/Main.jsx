...
function Main() {
    ...
    useEffect(() => {
        ...
        const typed = new Typed(el.current, {
            strings: ["Swift", "SwiftUI", "UIKit", "iOS", "Zoho Cliq"],
            startDelay: 500,
            typeSpeed: 120,
            backSpeed: 50,
            backDelay: 1500,
    ...
    return (
        ...
        <section className="min-h-screen w-full relative flex items-center overflow-hidden">
            ...
            <div className="w-full max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 pt-24 md:pt-0 relative z-10">
                ...
                <div className="flex flex-col justify-center z-10">
                    ...
                    <div data-aos="fade-right" data-aos-delay="200">
                        <svg className="h-14 md:h-20 -ml-1" id="demo" viewBox="0 0 527 118" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                            <linearGradient id="paint0_linear_1_14" x1="492.669" y1="3" x2="492.669" y2="113.08" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint1_linear_1_14" x1="414.586" y1="33.08" x2="414.586" y2="113.24" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint2_linear_1_14" x1="341.073" y1="33.08" x2="341.073" y2="112.92" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint3_linear_1_14" x1="279.419" y1="5.88" x2="279.419" y2="113.08" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint4_linear_1_14" x1="214.341" y1="32.92" x2="214.341" y2="112.92" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint5_linear_1_14" x1="125.521" y1="33.08" x2="125.521" y2="114.2" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            <linearGradient id="paint6_linear_1_14" x1="41.24" y1="3.8" x2="41.24" y2="112.92" gradientUnits="userSpaceOnUse"><stop stopColor="#007AFF"/><stop offset="1" stopColor="#5AC8FA"/></linearGradient>
                            </defs>
                        </svg>
                    </div>

                    <div className="mt-4 mb-6" data-aos="fade-right" data-aos-delay="300">
                        <span className="text-2xl md:text-3xl text-white font-bold">iOS Developer</span>
                        <span className="text-2xl md:text-3xl text-gray-500 mx-3">|</span>
                        <span ref={el} className="text-2xl md:text-3xl text-[#007AFF] font-bold"></span>
                    </div>

                    <p className="text-gray-400 text-lg leading-relaxed mb-8 max-w-lg" data-aos="fade-right" data-aos-delay="400">
                        Building native iOS experiences at <span className="text-[#007AFF] font-semibold">Zoho Corporation</span>.
                        Crafting pixel-perfect, performant mobile apps with Swift & SwiftUI.
                    </p>

                    <div className="flex items-center gap-4 mb-8" data-aos="fade-up" data-aos-delay="500">
                        <a href="#CONTACT">
                            <button className="px-8 py-3 bg-[#007AFF] text-white rounded-full font-semibold hover:bg-[#0056b3] transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,122,255,0.4)]">
                                Get In Touch
                            </button>
                        </a>
                        <a href="#PROJECTS" className="px-8 py-3 border border-white/20 text-white rounded-full font-semibold hover:border-[#007AFF]/50 hover:text-[#007AFF] transition-all duration-300 backdrop-blur-sm">
                            View Work
                        </a>
                    </div>

                    {/* Social Links */}
                    <div className="flex items-center gap-5" data-aos="fade-up" data-aos-delay="600">
                ...
                {/* Right - Profile Image with glow effects */}
                <div className="flex items-center justify-center relative" data-aos="fade-left" data-aos-delay="300">
                    {/* Animated glow ring behind image */}
                    <div className="absolute w-[320px] h-[320px] md:w-[420px] md:h-[420px] rounded-full border-2 border-[#007AFF]/20 animate-spin" style={{ animationDuration: '15s' }}></div>
                    <div className="absolute w-[350px] h-[350px] md:w-[460px] md:h-[460px] rounded-full border border-[#5AC8FA]/10 animate-spin" style={{ animationDuration: '20s', animationDirection: 'reverse' }}></div>

                    {/* Gradient glow behind photo */}
                    <div className="absolute w-[280px] h-[280px] md:w-[380px] md:h-[380px] bg-gradient-to-br from-[#007AFF]/30 via-[#5856D6]/20 to-[#5AC8FA]/30 rounded-full blur-[60px]"></div>

                    {/* Profile image */}
                    <div className="relative w-[260px] h-[320px] md:w-[340px] md:h-[420px] rounded-3xl overflow-hidden border-2 border-white/10 shadow-[0_0_60px_rgba(0,122,255,0.2)]">
                        <img
                            src={profileImg}
                            alt="Santosh"
