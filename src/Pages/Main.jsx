...
// import main from "../assets/develop-web.gif"
import lottie from "lottie-web";
import reactLogo from "../assets/lottie.json";
...
function Mai () {
  ...
  useEffect(() => {
    ...
    const typed = new Typed(el.current, {
      strings: [`Web Developer`, "MERN Stack Developer", "Java Developer", "JS Developer"],
      startDelay: 300,
      typeSpeed: 100,
      backSpeed: 100,
      backDelay: 100,
    ...
    return ( 
        <>
        <div className="w-full h-[400px] grid grid-cols-1 md:grid-cols-2">
            ...
            <div id="react-logo" className="h-[350px] w-full invisible md:visible" />
        </div>
        </>
     );
}
